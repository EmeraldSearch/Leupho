...
def git_push() -> None:
    try:
        subprocess.run(["git", "-C", BASE_DIR, "add", "data/", "index.html", "graph.html", "pace.html", "inventory_sprites.png", "inventory_sprites.json", "skin.png"], check=True, capture_output=True)
